...
PWM IN External DUT Channel 1 Test
    Wait Until Keyword Succeeds    5x    1s    PWM IN Channel 1 Should Be Valid

PWM IN External DUT Channel 2 Test
    Wait Until Keyword Succeeds    5x    1s    PWM IN Channel 2 Should Be Valid

PWM IN Frequency And Duty Separate Read Test
    Wait Until Keyword Succeeds    5x    1s    PWM IN Separate Measurements Should Be Valid


*** Keywords ***
PWM IN Channel 1 Should Be Valid
...
PWM IN Channel 2 Should Be Valid
...
PWM IN Separate Measurements Should Be Valid
